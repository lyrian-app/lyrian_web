      ...
      <div className={style.qa}>
        <Main>
          <div className={content.content}>
            ...
            <p>
              以下によくある質問をまとめておりますが、もし該当しない質問をお持ちの方は、
              <a
            ...
            <p>利用規約を遵守していただければ、使用できます。</p>

            <h3>Q: Lyrianが使用できないケースはありますか？</h3>
            <p>利用規約を遵守していただければ、例外なくご利用いただけます。</p>

            <h3>
              Q:
              Lyrianを使った曲を公開する際、報告やクレジット表記は必要ですか？
            </h3>
            <p>
