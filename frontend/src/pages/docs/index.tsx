        ...
        <Main>
          <div className={content.content}>
            ...
            <ul>
              ...
              <li>
                <a href="#Lyrianを使うコツ">Lyrianを使うコツ</a>
              </li>
              <ul>
                <li>
                  <a href="#1_ビルド&スクラップ">1. ビルド & クラップ</a>
                </li>
                <li>
                  <a href="#2_アイデアのきっかけとして使う">
                    2. アイデアのきっかけとして使う
                  </a>
                </li>
              </ul>
              <li>
                <a href="#Lyrianにできないこと">Lyrianにできないこと</a>
              </li>
            </ul>
            ...
            <p>
              例えば、「すもももももももものうち」という文章をマルコフ連鎖を用いて考えてみましょう。この文章を単語レベルで分解し、それぞれの単語の次に来る単語をカウントすると以下のようになります。
            </p>
            <ul>
              <li>すもも</li>
              <ul>
            ...
            <p>
              ここからマルコフ連鎖では、上記のカウントを「対象の単語の次に来得る単語の確率」として捉えます。つまり、
            </p>
            <ul>
              <li>すもも</li>
              <ul>
            ...
            <p>
              例えば「もも」という単語の次には「も」と「の」が1回ずつ現れました。マルコフ連鎖ではこの状態を『「もも」という単語が出てきたら、前後の文脈に関係なく、「も」か「の」どっちかにそれぞれ50％の確率で遷移する』と捉えます。
            </p>
            <p>
              このように、
              <u>
            ...
            <p>
              Lyrianでは、上記のような確率テーブルをユーザーが入力した文章から作成し、そのテーブルを基に歌詞生成を行います。
              <br />
              つまり、単語を1つランダムに選択し、その単語の次に来得る単語を上記のような確率テーブルの基でランダムに決定し、そしてその単語の次に来得る単語を……といった具合に、
            ...
            <p>
              この問題を踏まえ、Lyrianでは音符に言葉を割り当てる際に、その言葉のシラブルや無声子音などを考慮することで、
              <span className={content.emphasis}>
                1つの音符に対するサウンドの情報量を増やす
              </span>
              ことで、この平坦さの解消を試みています。
            </p>
            <p>
              例えばシラブルとは、簡単に説明すると「発音しやすい音の区切り」といったものです。
              <br />
            ...
            <p>
              もちろん、これらはあくまで機械的に計算すれば、という話です。「音数を詰め込めばリズミカルな歌詞になる」というほど、作詞の世界は単純ではありません。
              <br />
              しかし逆に、機械的に計算するからこそ、
              <span className={content.emphasis}>
                自分では思いつかないような歌詞を提案してくれる
              </span>
              というのがLyrianの強みでもあります。
            </p>
            ...
            <p>
              もしよろしければ、Lyrianを使ったことを共有していただけると、このアプリの開発者が喜びます。
            </p>

            <h2 id="Lyrianを使うコツ">Lyrianを使うコツ</h2>
            <h3 id="1_ビルド&スクラップ">1. ビルド & スクラップ</h3>
            <p>
              Lyrianを使って作詞をする場合は、
              <span className={content.emphasis}>
                とにかく歌詞生成ボタンを押しまくってください。
              </span>
            </p>
            <p>
              このアプリケーションはいわば<b>「作詞ガチャ」</b>
              です。必ずしも1発目でSSR級のフレーズが生まれるわけではありません。なので、少しでもイマイチだと感じた歌詞は遠慮なく切り捨て、よりビビッと来るものを探し求めたほうが結果的に良い歌詞が生まれやすくなります。
            </p>
            <h3 id="2_アイデアのきっかけとして使う">
              2. アイデアのきっかけとして使う
            </h3>
            <p>
              Lyrianは前後の文脈やメロディーを無視して歌詞を生成するため、単純にボタンをポチポチするだけでは奇天烈な歌詞しか生まれません。なので、提案された歌詞を修正して使ったり、制作中に自分で思いついたフレーズを使うといったように、Lyrianを
              <span className={content.emphasis}>アイデアのきっかけ</span>
              として用いるようにしましょう。
            </p>

            <h2 id="Lyrianにできないこと">Lyrianにできないこと</h2>
            <p>
              Lyrianは、
              <span className={content.negative}>全自動の作詞</span>
              には向いていません。
            </p>
            <p>
              Lyrianはランダム性や機械性を用いた歌詞生成を行うため、メロディーや歌詞全体を通した文脈等の解釈を行いません。そのため、完全自動で作詞を行うと、大抵意味不明な歌詞しか生成されません。
            </p>
            <p>
              Lyrianはあくまでアイデアのきっかけであり、
              <u>ユーザーによる歌詞の修正・加筆を前提としたアプリケーション</u>
              であることにご注意ください。
            </p>
          </div>
        </Main>
